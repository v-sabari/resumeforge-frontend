...
export const FeatureSection = () => (
  <SectionContainer id="features">
    <div className="max-w-3xl">
      ...
      <h2 className="section-heading mt-4">A premium frontend redesign that still respects the product’s working logic.</h2>
    ...
    <div className="mt-12 grid gap-6 lg:grid-cols-2">
      <Card className="p-6 sm:p-8" hover>
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-700">Built for real job searches</p>
      ...
      <Card className="p-6 sm:p-8" hover>
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-700">Designed for trust</p>
