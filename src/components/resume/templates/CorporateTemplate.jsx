...
export const CorporateTemplate = ({ data }) => {
  ...
  return (
    <div className="resume-template corporate max-w-4xl mx-auto bg-white px-8 font-sans overflow-hidden">
      {personalInfo && (
        <div className="bg-gray-900 text-white -mx-8 px-8 pb-4 mb-6">
          <h1 className="text-3xl font-bold mb-1 break-words">{personalInfo.fullName}</h1>
          {personalInfo.title&&<div className="text-base text-gray-300 font-medium mb-2 break-words">{personalInfo.title}</div>}
