        ...
        <div className="grid grid-cols-1 gap-0 xl:grid-cols-[248px_minmax(0,1fr)_440px] 2xl:grid-cols-[264px_minmax(0,1fr)_500px]">
          ...
          <div className="space-y-6 p-4 sm:p-6 xl:border-r xl:border-slate-200">
            <SectionCard
              ...
              description="Keep your resume header sharp, scannable, and recruiter-friendly."
            >
            ...
            >
              ...
              <input
                className="input"
                value={skillsText}
                onChange={(e) => updateTopField('skills', toArray(e.target.value))}
              />
            </SectionCard>
                      ...
                      {[
                        ...
                        <div key={field} className={field === 'location' ? 'md:col-span-2' : ''}>
                          ...
                          <input
                            ...
                            value={item[field] || ''}
                            onChange={(e) =>
                              updateArrayItem('experience', item.id, field, e.target.value)
                            }
                          />
                        </div>
                      ))}
                    ...
                    <div className="grid gap-4">
                      {[
                        ...
                        <div key={field}>
                          ...
                          <input
                            ...
                            value={item[field] || ''}
                            onChange={(e) =>
                              updateArrayItem('projects', item.id, field, e.target.value)
                            }
                          />
                        </div>
                      ))}
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            updateArrayItem('projects', item.id, 'description', e.target.value)
                          }
                        />
                      </div>
                    </div>
                      ...
                      {[
                        ...
                        <div key={field} className={field === 'location' ? 'md:col-span-2' : ''}>
                          ...
                          <input
                            ...
                            value={item[field] || ''}
                            onChange={(e) =>
                              updateArrayItem('education', item.id, field, e.target.value)
                            }
                          />
                        </div>
                      ))}
            ...
            <SectionCard
              ...
              actions={
                <button type="button" className="btn-secondary" onClick={addCertification}>
                  <Icon name="plus" className="h-4 w-4" />
                  Add certification
                </button>
              }
                      ...
                      {[
                        ...
                        <div key={field}>
                          ...
                          <input
                            ...
                            value={item[field] || ''}
                            onChange={(e) =>
                              updateArrayItem('certifications', item.id, field, e.target.value)
                            }
                          />
                        </div>
                      ))}
            ...
            <SectionCard
              ...
              eyebrow="Highlights"
              title="Achievements"
              description="Use one line per achievement to keep the section crisp."
            >
              <textarea
                className="input min-h-32"
